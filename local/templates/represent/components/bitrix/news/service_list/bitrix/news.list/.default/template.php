...
<section class="services" id="services-scroll">
	<div class="wrap">
		...
		<div class="serv-box serv-slider">
		<?foreach($arResult["ITEMS"] as $arItem):?>
		<div class="service_slide">
			<a class="serv-item" href="<?= $arItem['DETAIL_PAGE_URL']; ?>">
				<div>
					<div class="img-box">
						<img class="obj-fit serv-img" src="<?= $arItem['PREVIEW_PICTURE']['SRC']; ?>">
					</div>
					<?php $serv_name = $arItem['NAME']; ?>
					<div class="serv-name">
						<?= $serv_name; ?>
					</div>
				</div>
